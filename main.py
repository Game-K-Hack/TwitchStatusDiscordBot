...
client = commands.Bot(command_prefix="!ts ", help_command=None, intents=default_intents, activity=discord.Streaming(name="Twitch", url="https://www.twitch.tv/game_k_"))
