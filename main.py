...
client = commands.Bot(command_prefix="!ts beta ", help_command=None, intents=default_intents, activity=discord.Streaming(name="Status: !ts help", url="https://www.twitch.tv/game_k_"))
